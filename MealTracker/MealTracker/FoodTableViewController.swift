...
class FoodTableViewController: UITableViewController {
    ...
    var meals: [Meal] {
        let breakfast = Meal(name: "Breakfast", food: [
            ...
            Food(name: "Coffee", description: "Hot brewed coffee")
        ])

        let lunch = Meal(name: "Lunch", food: [
            Food(name: "Sandwich", description: "Veg sandwich"),
            Food(name: "Salad", description: "Fruit salad"),
            Food(name: "Juice", description: "Orange juice")
        ])

        let dinner = Meal(name: "Dinner", food: [
            Food(name: "Pasta", description: "Creamy pasta"),
